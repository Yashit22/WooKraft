...
const testimonials = [
  {
    name: "Spice POS",
    sub_content: "Restaurant POS System",
    content:
      "Enhance restaurant efficiency with a POS system that streamlines order management, payment processing, customer service, and much more, all in one solution.",
    categories: [1, 2],
  },
  {
    name: "Woo POS",
    sub_content: "Retail POS System",
    content:
      "Boost retail efficiency with a POS system that simplifies inventory management, sales processing, customer tracking, and much more, all in one seamless solution.",
    categories: [1, 3, 5],
  },
  {
    name: "Luxe POS",
    sub_content: "Salon/Spa POS System",
    content:
      "Simplify salon operations with a tailored POS system, streamlining appointments, payments, and customer management in one place.",
    categories: [1, 4],
  },
  {
    name: "Clienteling",
    sub_content: "Customer Engagement Platform",
    content:
      "Build stronger customer relationships with clienteling software that personalizes service, tracks preferences, runs targeted marketing campaigns, and enhances loyalty.",
    categories: [1, 2, 3, 4, 5],
  },
  {
    name: "Kitchen Display System",
    sub_content: "Kitchen Order Tickets Management",
    content:
      "Streamline your kitchen operations with a Kitchen Display System(KDS) to fire orders directly to the kitchen. KDS organizes orders in real-time, enabling chefs to focus on cooking while minimizing errors, even during peak hours.",
    categories: [1, 2],
  },
  {
    name: "Scan N' Dine",
    sub_content: "Digital Dining Experience",
    content:
      "Enhance customer convenience with seamless self-ordering—just scan a QR code to browse the menu, customize orders, and pay directly from their device. Most suitable for QSRs, Cafés and Bars." ,
    categories: [1,2],
  },
  {
    name: "Self-Checkout KIOSK",
    sub_content: "Seamless Self-Checkout",
    content:
      "Enhance customer convenience with seamless self-checkout kiosks, allowing quick browsing, payment, and checkout for retail and QSRs.",
    categories: [1, 2, 3],
  },
  {
    name: "Analytics & Insights",
    sub_content: "Actionable Business Insights",
    content:
      "Unlock data-driven decisions with analytics and insights software, empowering businesses to optimize operations and boost performance. ",
    categories: [1, 2, 3, 4, 5],
  },
  {
    name: "Omni-Channel Presence",
    sub_content: "Your Business Online",
    content:
      "Expand your reach and drive sales with omnichannel selling through a dedicated website or app, ensuring a seamless customer experience across platforms.",
    categories: [1, 2, 3, 5],
  },
];
...
export function Testimonial({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 transition-colors hover:text-indigo-500">
          <div className="text-xl font-bold text-gray-150 ">
            <span>{testimonial.name}</span>
          </div>
          <span className="text-indigo-200">{testimonial.sub_content}</span>
        <p className="text-indigo-200/70 item-center before:content-['“'] after:content-['”']">
          {children}
        </p>
        </div>
      </div>
